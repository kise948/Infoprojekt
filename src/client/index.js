...
async function executeQuery(queryNumber) {
    ...
    // Pass data to chart creation functions
    if (queryNumber === 1) {
...
document.getElementById('query1-button').addEventListener('click', () => console.log("Click1"));
...
async function updateChart(data) {
    ...
    // Generate the SVG using the pie chart data
    const svg = await createPieChart(data);
